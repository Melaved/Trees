 ...
 *
 * This function recursively deallocates memory in the binary tree.
 *
...
/*
 * @brief Help to find min value in the tree.
 *
 * This function traverses to the leftmost node to find the minimum value.
 *
 * @param binaryTree A pointer to the current node in the binary tree.
...
/*
 * @brief Clear nodes in the binary tree.
 *
 * This function recursively deallocates memory in the binary tree.
 *
 * @param binaryTree A pointer to the node in binary tree.
 */
